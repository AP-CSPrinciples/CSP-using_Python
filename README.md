...
<details><summary>Click Here</summary>
  ...
  **Guidelines for good code design**
    ...
    Here are two ways to break up a long string:
      ...
      # (1) use two print statements and ',' after the first print
      #     statement so that it does not print out a carriage return:

      print "here is a really long string with an int value, %d," %(x),
      print " that I want to print to stdout"

      # (2) use one print statment and the stmt continuation char '\' 
      #     and string concatenation (+) to break into 2 lines
