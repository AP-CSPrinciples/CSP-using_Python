...
### 5-Point Performance-Based Assessment Rubric

| **Criteria** | **5 - Exemplary** | **4 - Proficient** | **3 - Basic** | **2 - Developing** | **1 - Needs Improvement** |
| --- | --- | --- | --- | --- | --- |
| **Task Completion** | Completes the task with exceptional skill and attention to detail; exceeds expectations. | Completes the task with few errors; meets expectations. | Completes the task with some errors or omissions; partially meets expectations. | Completes only part of the task, or completes it with frequent errors that affect the outcome. | Does not complete the task or completes it with significant errors or omissions. |
| **Quality of Work** | Work is of the highest quality, demonstrating mastery and deep understanding. | Work is of good quality, demonstrating solid understanding and competence. | Work is of acceptable quality, demonstrating basic understanding but lacks depth. | Work shows inconsistent understanding; quality is uneven and depth is minimal. | Work is of poor quality, demonstrating a lack of understanding or effort. |
| **Creativity & Innovation** | Demonstrates exceptional creativity and originality in approach or solution. | Demonstrates creativity and originality, though somewhat predictable. | Demonstrates limited creativity or originality; solution is basic or repetitive. | Shows minimal creativity; approach closely mirrors examples or templates with little adaptation. | Lacks creativity or originality; approach or solution is overly simplistic. |
| **Communication & Presentation** | Communicates ideas clearly and effectively with well-organized, professional presentation. | Communicates ideas clearly, with an organized and mostly professional presentation. | Communicates ideas with some clarity, but the presentation may be unorganized or unclear. | Communicates ideas inconsistently; presentation has noticeable gaps in organization or clarity. | Struggles to communicate ideas clearly; presentation is disorganized or hard to follow. |
